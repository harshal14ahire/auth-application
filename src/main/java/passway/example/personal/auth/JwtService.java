...
public class JwtService {
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        return buildToken(claims, userDetails.getUsername(), appProperties.jwt().expirationMs());
    }
    ...
    public String generateMfaPendingToken(String username) {
        ...
        return buildToken(claims, username, appProperties.jwt().mfaExpirationMs());
    }
    ...
    public String generateTokenAfterMfa(String username, Collection<? extends GrantedAuthority> authorities) {
        ...
        claims.put("mfa_verified", true);
        return buildToken(claims, username, appProperties.jwt().expirationMs());
    }
